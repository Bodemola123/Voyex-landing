...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      <body
        className={`${inter.variable} antialiased scroll-container scrollbar-hide overflow-hidden md:bg-[url('/stars.svg.svg')] sm:bg-[#0a0a0b] w-full h-full bg-cover bg-no-repeat bg-fixed bg-center bg-origin-content`}
      >
