...
// const FullBlog = () => {
//   return (
//     <div className="text-white min-h-screen py-10 px-6 lg:px-20">
//       <div className="max-w-5xl mx-auto">
//         {/* Blog Card Image Section */}
//         <div className="w-full h-[80vh] overflow-hidden mt-12 mb-12">
//           <img
...
//               style={{ fontFamily: "DM Sans, sans-serif", marginBottom: "12px" }}
//             >
//                 AI is no longer reserved for tech teams or enterprise labs. From solopreneurs to creative teams, more people are looking for <span className="block mt-2">ways to bring AI into their everyday tasks — whether it’s writing, marketing, research, or productivity. That’s exactly where </span> <span className="block mt-2"> Voyex comes in.</span>
//             </p>
//           </div>

//           {/* What Is the Query Engine Section */}
//           <div>
//             <h2
//               className="text-[32px] leading-[100%] tracking-[-0.02em] font-bold mb-6"
//               style={{ fontFamily: "DM Sans, sans-serif" }}
...
//               style={{ fontFamily: "DM Sans, sans-serif", marginBottom: "12px" }}
//             >
//              Voyex is an AI tool discovery platform that helps users find the right tools for the right job. Whether you're launching a <span className="block mt-2">  product, building content, or automating a process — Voyex guides you from idea to action.</span>
//             </p>
//           </div>
...
//             <ol className="list-disc list-inside space-y-6 text-[18px] leading-[100%] font-normal text-[#FFFFFF]">
//               <li>
//                 <span className="font-semibold">Instant Discovery:</span> Just ask what you need to do — like "write ad copy" or "build a landing page" — and Voyex <span className="block mt-2"> recommends tools made for the task.</span>
//               </li>
//               <li>
//                 <span className="font-semibold">Prompt Suggestions:</span> Get tailored prompts that work out of the box, so you don’t waste time figuring out how <span className="block mt-2">to talk to AI.</span>
//               </li>
//               <li>
//                 <span className="font-semibold">Pre-Built Templates:</span> Browse templates for common tasks like social media planning, product research, and <span className="block mt-2"> more — all powered by AI.</span>
//               </li>
//             </ol>
//           </div>
...
//               style={{ fontFamily: "DM Sans, sans-serif", marginBottom: "12px" }}
//             >
//               You no longer have to guess which tools to use or how to use them. Voyex shortens the distance between your goals and <span className="block mt-2">the AI tools that can help achieve them. </span>
//             </p>
//           </div>
...
//               style={{ fontFamily: "DM Sans, sans-serif", marginBottom: "12px" }}
//             >
//                Voyex brings AI into your workflow — not as an extra layer, but as a natural extension of how you already work. And it’s just <span className="block mt-2">getting started.</span>
//             </p>
//           </div>
//         </div>
//       </div>
