...
const ProductCard = ( {product} ) => {
  ...
  return (
    <div className='w-auto lg:rounded-3xl md:rounded-[17.84px] sm:rounded-[17.84px] flex flex-col lg:gap-4 md:gap-[7.13px] sm:gap-[7.13px] lg:p-6 md:p-[17.12px] sm:p-[17.12px] bg-custom-gradient backdrop-blur-custom text-white'
    style={{
    ...
    >
        ...
        {hovered && (
            <div>
                <Link href='' passHref>
                <button className="w-full bg-[#c088fb] lg:py-2 lg:px-4 md:py-[6.42px] md:px-[11.42px] sm:py-[6.42px] sm:px-[11.42px] md:gap-[7.13px] sm:gap-[7.13px] lg:gap-2.5 rounded-3xl flex items-center flex-row justify-center">
