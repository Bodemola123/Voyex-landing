...
const ProductCard = ({ product }) => {
  ...
  return (
    <div 
      ...
      style={{
        background: 'linear-gradient(90.83deg, rgba(255, 255, 255, 0.1) 0%, rgba(255, 255, 255, 0.05) 100%)',
        border: '1px solid rgba(255, 255, 255, 0.2)', // Adding a border for better contrast
