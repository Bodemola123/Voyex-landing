...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center sm:h-[72px] lg:px-[24px] md:px-[24px] sm:px-[24px] z-40">
      ...
      <Link href="/pricing" className="hover:text-[#C088fb]">Pricing</Link>
  <Link href="/resources" className="hover:text-[#C088fb]">Resources</Link>
  <Link href="/about-us" className="hover:text-[#C088fb]">About us</Link>
  <Link href="/blog" className="hover:text-[#C088fb]">Blog</Link>
      </div>
...
<ul className="flex flex-col gap-4">
  <li className="hover:text-[#C088fb]">
