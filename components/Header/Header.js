...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center sm:h-[72px] lg:px-[24px] md:px-[24px] sm:px-[24px] z-40 mt-3.5">
      ...
      {/* Desktop Navigation */}
      <div className="hidden lg:flex md:flex sm:text-sm lg:text-base font-semibold lg:gap-10 lg:py-3 lg:px-[60px] md:gap-5 md:px-5 md:py-2 border border-card rounded-[43px]">
      ...
      <a 
        ...
        className="sm:hidden lg:flex md:flex bg-[#c088fb] rounded-3xl md:rounded-[27px] border-[1.5px] border-[#c088fb] text-[#0a0a0b] text-base flex gap-2 lg:py-[6px] lg:px-9 md:py-[6px] md:px-9 transition-all duration-200 ease-in-out hover:scale-110 hover:bg-[#9b67d7] hover:backdrop-blur-[18.4px]"
      >
        Go to App
      </a>
