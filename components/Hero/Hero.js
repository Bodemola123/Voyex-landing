...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center text-center lg:mt-[50px] md:mt-[92.82px] sm:mt-[91px]'>
      ...
      <p className="flex justify-center items-center md:mt-6 lg:mt-6 sm:mt-[5.97px] lg:text-xl md:text-base sm:text-base text-[#ffffff] md:leading-[25.6px] sm:leading-[23.92px] lg:w-[977px] text-center md:w-[584.27px] sm:w-auto sm:px-12 md:px-0">
