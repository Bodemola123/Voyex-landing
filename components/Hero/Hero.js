...
>
        ...
        <div className="flex gap-4">
          ...
          <button className="bg-[#F4F4F4] text-[#0A0A0B] lg:px-8 lg:py-4 md:px-5 md:py-2 sm:px-3.5 sm:py-2 rounded-[27px] lg:font-medium font-base lg:text-lg sm:text-sm md:text-base hover:scale-105 transition">
            Upload Product
          </button>
        </div>
        {/* Background orbits with reduced scale and blur */}
