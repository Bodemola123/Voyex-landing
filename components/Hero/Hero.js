...
const Hero = () => {
  return (
    <div className='flex flex-col items-center justify-center text-center lg:mt-[50px] md:mt-[220.82px] sm:mt-[221px]'>
      ...
      <p class="flex justify-center items-center md:mt-6 lg:mt-6 sm:mt-[5.97px] lg:text-xl md:text-base sm:text-sm text-[#ffffff] md:leading-[25.6px] sm:leading-[17.92px] lg:w-[977px] text-center md:w-[584.27px] sm:w-[350px]">
Voyex is your superapp for finding the right AI tools and workflows tailored to your use case. Describe your needs, and it helps you build a mini agency effortlessly.
      ...
      <div className='flex md:flex-row lg:flex-row sm:flex-col sm:gap-[14px] lg:gap-4 md:gap-[9.57px] mt-5 justify-center items-center'>
