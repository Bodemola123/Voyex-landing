...
const CTA = () => {
  return (
    <div
      className="flex flex-col items-center justify-center z-10 px-4 md:px-12 lg:px-[170px] mx-auto relative lg:top-[-500px] md:top-[-300px] sm:top-[-300px] lg:max-w-[1326px] mt-40 mb-40 w-full"
      data-aos="fade-up"
    >
      {/* "Our Audience" Label */}
