...
const CTA = () => {
  ...
  return (
    ...
    <button className='lg:mt-[55px] md:mt-[15px] sm:mt-[5px] lg:rounded-[27px] md:rounded-[16.43px] sm:rounded-[23px] flex font-medium bg-[#f4f4f4] text-[#032400] lg:px-[35px] md:px-[21.29px] sm:px-[21.29px] sm:py-3 lg:py-2.5 md:py-3 lg:gap-2.5 md:gap-[6.08px] sm:gap-[6.08px]'>Get started</button>
    </div>
  );
};
