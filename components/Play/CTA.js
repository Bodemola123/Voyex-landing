...
// <div className="flex flex-col mt-2 ml-[-60px] mr-[-60px] mx-auto rounded-lg h-[800px]">
//   {/* Top Row - Cards 01 & 02 side by side with gap */}
//   <div className="flex flex-row gap-6 p-6">
//     {/* Card 01 */}
//     <div className="group flex-1 p-8 text-center border border-white/10 rounded-lg bg-[#0D0D0D]">
...
//     <div className="group w-2/3 p-8 text-center border border-white/10 rounded-lg bg-[#0D0D0D]">
...
//   return (
//     <div
//       className="flex flex-col items-center justify-center z-10 px-4 md:px-12 lg:px-[170px] mx-auto relative lg:top-[-315px] md:top-[-145px] sm:top-[-200px] lg:max-w-[1100px] w-full"
//       data-aos="fade-up"
//     >
//       {/* "Our Audience" Label */}
...
//         {/* Card 01 */}
//         <div className="group flex-1 p-8 text-left border border-white/10 rounded-lg bg-[#0D0D0D]">
...
//       {/* CTA Button */}
//       <button className="mt-8 bg-white text-black font-medium py-2 px-6 rounded-full hover:bg-opacity-90 transition">
//         Mail us Today!
//       </button>
//     </div>
//   );
