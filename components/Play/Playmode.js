...
const Playmode = () => {
  return (
    <div className='flex justify-center items-center md:mt-[159px] sm:mt-[75.32px]'>
<div className='border rounded-[18px] border-card flex justify-center items-center lg:w-[1131px] lg:h-[635px] md:w-[730px] md:h-[409px] sm:w-5/6 sm:h-[193px]' 
  style={{ 
