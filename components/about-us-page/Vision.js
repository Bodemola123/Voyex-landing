...
const Vision = () => {
  ...
  return (
    <div className='flex md:flex-row-reverse sm:flex-col-reverse items-center justify-center lg:gap-6 mt-27 md:gap-6 sm:gap-6 md:px-5 sm:px-5 h-screen'>
      <div className='flex flex-col md:gap-[23px] sm:gap-4 items-center justify-center sm:ml-0'>
      <p
    data-aos='fade-up'
    className='text-[#f4f4f4] font-semibold lg:text-3xl md:text-lg sm:text-base mb-0'
  >
    Voyex envisions a world where :
  </p>
  {[
  "People ask natural questions — and get AI-powered action plans.",
  "Businesses build custom AI workflows in minutes.",
  "Teams stop searching for tools and start solving problems."
].map((text, index) => (
  <div
    key={index}
    data-aos='fade-up'
    className='flex flex-row items-center justify-start md:py-4 sm:py-2 sm:px-2 md:pl-7 md:pr-2 border rounded-[10px] border-[#ffffff20] bg-[#0d0d0d] md:gap-6 sm:gap-4 transition-all duration-500 ease-in-out lg:w-[538px] md:w-[458px] sm:w-[290px]'
  >
