...
const Final = () => {
  ...
  const [success, setSuccess] = useState(false); // State to track if the form submission was successful
  ...
  return (
    <div className="-mt-[400px] flex flex-col lg:px-[120px] md:px-[10px] sm:px-[16px]">
      <div className="flex flex-row sm:gap-[40px] justify-center items-center sm:mx-auto">
        <Image
          ...
          width={263}
          height={263}
          className="relative lg:top-[36px] md:top-[-136px] lg:left-0 md:right-[0px] sm:hidden lg:flex md:hidden message-bubble"
        />
        <div className="flex flex-col gap-[20px]">
          <h1 className="md:font-bold sm:font-normal md:text-[54px] sm:text-[32px] mt-[100px] text-center text-[#ffffff]">
            Get instant access
          </h1>
          <p className="text-[#bbbbbb] text-base sm:w-auto md:w-[447px] font-normal text-center">
            Celebrate the joy of accomplishment with an app designed to track
            your progress and motivate your efforts.
          </p>
          <form
            onSubmit={handleSubmit}
            className="flex md:flex-row sm:flex-col justify-center gap-2.5 items-center"
          >
            ...
            <button
              type="submit"
              className={`py-2.5 px-[15px] flex gap-1 bg-[#ffffff] text-[#000000] font-medium md:text-base sm:text-sm rounded-[27px] sm:w-[136px] md:w-auto items-center justify-center ${
                isSubmitting
        ...
        <Image
          ...
          width={225}
          height={225}
          className={`relative lg:top-[35px] md:top-[38px] lg:left-0 md:left-[0px] sm:hidden lg:flex md:hidden ${
            isInView ? "rotate-infinite" : ""
          }`}
          ref={boltRef}
        />
      </div>
      <div className="md:mt-[40px] sm:mt-[72px] border-t border-white/20 flex md:flex-row sm:flex-col md:px-[40px] md:py-[20px] sm:py-[50px] md:justify-between sm:justify-center sm:items-center sm:gap-3 md:gap-0">
        <p className="text-sm font-normal text-center text-[#808080]">
          @ 2025 VOYEX, Inc. All rights reserved
        </p>
        ...
        <div className="flex flex-row lg:gap-[16px] md:gap-[15px] sm:gap-[15px] justify-center items-center">
          <div className="social-icon hover:scale-125 transition-transform duration-200 cursor-pointer">
