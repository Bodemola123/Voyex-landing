...
const Privacy = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 px-4">
      <div className="bg-[#0d0d0d] text-white rounded-2xl border border-[#FFFFFF33] p-6 max-w-2xl w-full sm:w-[90%] md:w-[80%] lg:w-[80%] overflow-y-auto lg:h-[80%] sm:h-[80%] scrollbar-hide">
        <h1 className="lg:text-2xl sm:text-base font-semibold mb-4 text-center">Privacy Policy</h1>
        <p className="lg:text-base sm:text-sm text-gray-300 mb-4  max-h-[60vh]">
        ...
        <h1 className="lg:text-lg sm:text-base font-semibold mb-2 text-left">1. Information We Collect</h1>
        ...
        <h1 className="lg:text-lg sm:text-base font-semibold mb-2 text-left">2. How we use your Information</h1>
        <p className="lg:text-base sm:text-sm text-gray-300 mb-4 flex flex-col gap-1 max-h-[60vh]">
        ...
        <h1 className="lg:text-lg sm:text-base font-semibold mb-2 text-left">3. Data Protection and security</h1>
        <p className="lg:text-base sm:text-sm text-gray-300 mb-4 flex flex-col gap-1 max-h-[60vh]">Voyex implements industry-standard security measures to protect your personal data from unauthorized access, disclosure, or alteration. We do not sell or share your data with third parties without your consent.</p>
        <h1 className="lg:text-lg sm:text-base font-semibold mb-2 text-left">4. User Control and Rights</h1>
        <p className="lg:text-base sm:text-sm text-gray-300 mb-4 flex flex-col gap-1 max-h-[60vh]">
        ...
        <h1 className="lg:text-lg sm:text-base font-semibold mb-2 text-left">5. Data Retention</h1>
        <p className="lg:text-base sm:text-sm text-gray-300 mb-4 flex flex-col gap-1 max-h-[60vh]">We retain your data only for as long as necessary to fulfill the purposes outlined in this policy, comply with legal requirements, and resolve disputes.</p>
        <h1 className="lg:text-lg sm:text-base font-semibold mb-2 text-left">6. Third-Party Services</h1>
