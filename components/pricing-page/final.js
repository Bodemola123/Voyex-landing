    ...
    return (
      <div className='md:mt-[126px] sm:mt-[126px] flex flex-col lg:px-[120px] md:px-[10px] sm:px-[16px]'>
          <div className='flex flex-row sm:gap-[40px] justify-center items-center sm:mx-auto'>
              <Image src={'/Chart.svg'} alt='chart' width={225} height={225} className='relative lg:top-[36px] md:top-[-136px] lg:left-0 md:right-[0px] sm:hidden lg:flex md:hidden message-bubble'/>
              <div className='flex flex-col gap-[20px]'>
              <h1 className="text-white lg:text-[44px] md:text-[38px] sm:text-[32px] font-bold leading-tight text-center">Get Notified</h1>
                  <p className='text-[#bbbbbb] text-base sm:w-auto md:w-[447px] font-normal text-center'>We're putting the finishing touches on our pricing plans. Drop your mail below, and we'll notify you the moment they go live.</p>
                  <form onSubmit={handleSubmit} className='flex md:flex-row sm:flex-col justify-center gap-2.5 items-center'>
                      <div className='relative'>
                        ...
                        ||
                        success && (
                          <div className="absolute text-sm text-green-500 top-full mt-1">{success}</div>
                        )}
                      </div>
                      <button
                          type='submit'
          ...
          <div className='md:mt-[40px] sm:mt-[72px] border-t border-white/20 flex md:flex-row sm:flex-col md:px-[40px] md:py-[20px] sm:py-[50px] md:justify-between sm:justify-center sm:items-center sm:gap-3 md:gap-0'>
            ...
            <div className='flex space-x-4 text-sm'>
              <a href="/privacy" className="hover:underline text-[#808080]">Privacy Policy</a>
