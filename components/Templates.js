...
const Templates = () => {
  ...
  return (
    <div 
      className="flex flex-col lg:gap-[53px] md:gap-[37.81px] sm:gap-[37.87px] sm:py-[84px] sm:px-[30px] lg:p-28 md:px-[30px] md:py-[84px] justify-center items-center absolute lg:top-[3160px] md:top-[2510px] sm:top-[3080px] opacity-[0.89] mx-auto z-10"
      style={{
